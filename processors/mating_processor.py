...
# для всех блобсов, которые видят друг друга, составить пары
# для всех пар применить алгоритм find mate
# в этом алгоритме мы получаем только вероятности, что получаем потомство.
# отсортировать по вероятности
# у пар с наиб вероятностей, идут делать потомство
# для тех, что делает потомство, возможные исходы исключаются
# все, кто не может оставить потомство, идут искать еду.
