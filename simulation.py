...
# два метода: инит и процесс
# должен быть цикл, который тикает. на каждой итерации тик увеличивается на 1.
# набор процессоров, которые вызываются на определенных тиках
# затем доделать сериализацию и визуализацию
